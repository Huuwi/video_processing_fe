  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8">
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-blue-500/30 transition-all duration-500">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="w-full h-14 bg-white hover:bg-gray-100 text-gray-900 font-bold rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 relative overflow-hidden active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed group/btn shadow-xl shadow-white/5"
            >
              {isLoading ? (
